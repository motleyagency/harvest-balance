...
export const projectBalance = ({ startDate, endDate, harvestUserId }) =>
  fetch(
    `${BACKEND_ENDPOINT}/project-balance?startDate=${startDate}&endDate=${endDate}&harvestUserId=${harvestUserId}`,
    {
      headers: jsonHeaders(),
    },
  )
